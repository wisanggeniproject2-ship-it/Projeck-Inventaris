            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="stock" value="{{ old('stock', 1) }}" min="1" required
                           class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500">
                    <p class="text-xs text-gray-500 mt-1">Minimal 1. Stok akan berkurang saat dipinjam.</p>
                ...
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <ul class="text-sm text-blue-600 mt-1 list-disc list-inside">
                            <li>Membuat kode barang unik (format: H/001/10/01/x/2020/Y)</li>
                            <li>Membuat QR Code untuk barang ini</li>
                            <li>Stok akan berkurang saat dipinjam dan bertambah saat dikembalikan</li>
                        </ul>
