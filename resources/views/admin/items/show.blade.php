...
<div class="container mx-auto max-w-4xl">
    <div class="flex justify-between items-center mb-6">
        ...
        <div>
            ...
            <a href="{{ route('admin.items.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 ml-2">
            ...
            <table class="min-w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-t">
                        ...
                        <td class="px-4 py-2">{{ $circulation->return_date ? $circulation->return_date->format('d/m/Y') : '-' }}</td>
                        <td class="px-4 py-2">
