        ...
        <form action="{{ route('user.circulations.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="purpose" rows="3" required class="w-full px-3 py-2 border rounded-lg">{{ old('purpose') }}</textarea>
                </div>

                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p class="text-sm text-yellow-800">
                        <i class="fas fa-info-circle mr-2"></i>
                        Peminjaman akan diproses oleh admin. Status akan berubah menjadi "approved" setelah disetujui.
                    </p>
                </div>
            </div>
